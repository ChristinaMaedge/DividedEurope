...
summary(pca)
```
It shows the proportion of variance explained by each principle component. In the third row, the cumulative proportion, we see that the first two PCs  already account for 69% of the total variation in the data. If we are happy with this number, we can discard the remaining information. But how are these proportions calculated?
